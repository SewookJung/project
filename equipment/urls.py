...
urlpatterns = [
    ...
    re_path(r'^client/(?P<client_id>\d+)/(?P<mnfacture>\w+)/detail/$', views.equipment_mnfacture_detail,
            name="equipment_mnfacture_detail"),
    re_path(r'^client/(?P<client_id>\d+)/(?P<mnfacture>\w+)/(?P<model>\w+)/detail/$', views.equipment_model_detail,
